...
<p> OBS.: a classificação diz que se o resultado da previsão é que a pessoa sobreviveu, recebe 1 (um) na classificação. caso contrário, recebe 0 (zero) na classificação
